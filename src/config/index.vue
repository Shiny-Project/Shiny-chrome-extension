        ...
        <el-col :span="20" :offset="2">
            <el-card>
                ...
                <el-table :data="blockList">
                    ...
                    <el-table-column property="name" label="Spider Name" width="120"></el-table-column>
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <el-button type="text" @click="handleRemoveBlock(scope.row.name)">
                                删除
                            </el-button>
                        </template>
                    </el-table-column>
                ...
                <el-table :data="blockChannelList">
                    <el-table-column type="index" width="50"></el-table-column>
                    <el-table-column property="name" label="Spider:Channel" width="120"></el-table-column>
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <el-button type="text" @click="handleRemoveBlockChannel(scope.row.name)">
                                删除
                            </el-button>
                        </template>
                    </el-table-column>
                ...
                <el-table :data="starList">
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <el-button type="text" @click="handleRemoveStar(scope.row.name)">
                                删除
                            </el-button>
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        async handleRemoveBlock(name) {
            ...
            this.blockList = [...this.blockList.slice(0, index), ...this.blockList.slice(index + 1)];
        },
        async handleRemoveStar(name) {
            await storage.removeStar(name);
            const index = this.starList.findIndex((i) => i.name === name);
            this.starList = [...this.starList.slice(0, index), ...this.starList.slice(index + 1)];
        },
