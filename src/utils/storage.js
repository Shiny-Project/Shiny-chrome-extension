...
export function removeBlock(item) {
    return new Promise(async (resolve, reject) => {
        ...
        await setList("block", [...blockList.slice(0, index), ...blockList.slice(index + 1)]);
        resolve();
    });
}
...
export function removeStar(item) {
    return new Promise(async (resolve, reject) => {
        ...
        await setList("star", [...blockList.slice(0, index), ...blockList.slice(index + 1)]);
        resolve();
    });
}
...
export function addBlock(item) {
    return new Promise(async (resolve, reject) => {
        ...
        const blockList = await getList("block");
        await setList("block", [...blockList, item]);
        resolve();
    });
}
...
export function addStar(item) {
    return new Promise(async (resolve, reject) => {
        ...
        const blockList = await getList("star");
        await setList("star", [...blockList, item]);
        resolve();
    });
}
...
export function addBlockChannel(spiderName, channelName) {
    return new Promise(async (resolve, reject) => {
        ...
        await setList("block_channel", [...blockChannelList, `${spiderName}:${channelName}`]);
        resolve();
    });
}
...
export function removeBlockChannel(spiderName, channelName) {
    return new Promise(async (resolve, reject) => {
        ...
        await setList("block_channel", [...blockChannelList.slice(0, index), ...blockChannelList.slice(index + 1)]);
        resolve();
    });
}
